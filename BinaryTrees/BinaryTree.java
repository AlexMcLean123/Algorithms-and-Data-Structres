...
public class BinaryTree{
	//An example using the tree given in Lab 1
	//You can mess around with the different methods to see how it works
	public static void main(String args[]){
		...
		myTree.inOrder(myTree.getRoot()); // 17 18 20 42 45 64 65 67 72 83 87 92
		myTree.remove(64);
		System.out.println();
		myTree.inOrder(myTree.getRoot()); // 17 18 20 42 45 65 67 72 83 87 92
	}
}
